          ...
          >
            ...
            <Box sx={{ flexGrow: 0 }}>
              ...
              >
                ...
                <MenuItem sx={{ height: "300px", width: "240px" }} disableRipple>
                  <Box
                    sx={{
                      display: "flex",
                      flexDirection: "column",
                  ...
                  >
                    <div className="flex flexa g10 navuserwrap">
                      <span className="userImgNav"></span>
                      <p>Ankit</p>
                    </div>
                    ...
                    <FormControlLabel sx={{scale: "0.9"}} 
                    onClick={()=>{toggleTheme()}}
                      control={
                        <MaterialUISwitch sx={{ m: 1 }} defaultChecked disableRipple/>
                      }
                      label="Dark"
                    />
